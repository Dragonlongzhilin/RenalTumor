Palettes <- list(
  ...
  #lzl
  group_pal = c("#D51F26", "#272E6A", "#208A42", "#89288F", "#6387C5"),
  group_pal2 = c("#E64B35", "#4DBBD5", "#00A087", "#3C5488", "#F39B7F"),

  #20-colors
  group_stallion = c("1"="#F13A13","2"="#F47D2B","3"="#FEE500","4"="#83AD00","5"="#208A42", "6"="#00C0BA","7"="#7B6FD0","8"="#C06CAB","19"="#F37B7D",
              "10"="#e0598b"),
  
  stallion = c("1"="#EF7F48","2"="#D69100","3"="#C69900","4"="","5"="#00BE6B", "6"="#00C0BA","7"="#00B9E1","8"="#00B3F1","19"="#E6C2DC",
               "10"="#8794FF", "11"="#B086FF","12"="#E46DF6","13"="#F365E6","14"="#D24B27","15"="#3BBCA8", "16"="#6E4B9E","17"="#0C727C", "18"="#7E1416","9"="#00ABFD","20"="#3D3D3D"),

  stallion2 = c("1"="#EF7F48","2"="#D69100","3"="#C69900","4"="#83AD00","5"="#00BE6B", "6"="#FEE500","7"="#8A9FD1","8"="#C06CAB","19"="#E6C2DC",
